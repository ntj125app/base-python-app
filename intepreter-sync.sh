...
docker run --rm -it -v "$PWD":/app -v /home/python-site-packages:/usr/local/lib/python3.13/site-packages -w /app --network tools-net python:3.13-slim pip install -r requirements.txt --upgrade
